...
<form method="GET">
<input type="text" name="tag" size="50" value="<%= (tag == null ? "" : HTMLHelper.formatAttribute(tag)) %>"> <input type="submit" value="Search"> 
</form>
...
<div class="objectbox">
  ...
  <% List<String> tags = (List<String>) row.get("cmisbook:tags");
     if (tags != null && !tags.isEmpty()) { %>
  <div style="font-size: small;">
    Tags: <% for(String t: tags) { %><a href="<%= HTMLHelper.encodeUrlWithTag(request, t) %>"><%= HTMLHelper.format(t) %></a> <% } %>
  </div>
  <% } %>
 </div>
<% } %>
